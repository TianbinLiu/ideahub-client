...
5. mascot14（2026-09-05）：头转时眼/口/前发/后发/发夹一起平移（Shift X/Y 旋转变形器），Angle Z 头歪 ±12°，腮红网格由 ParamCheek 控不透明度；mascot15 再加眯眼（Eye L/R Squint 2×2 warp 把眼睛整体压扁，ParamEyeL/RSmile）。
